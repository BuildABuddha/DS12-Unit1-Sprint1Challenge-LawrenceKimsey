...
- Besides the obvious answer of if the code does what it's supposed to or not,
  readability is super important. If, for example, a code does five complex 
  things all at once in one line, then having a comment explaining it might
  be useful. Additionally, giving functions and variables understandable
  names helps make code easily understandable. Also, something that is 
  especially important for newbie programmers, sometimes someone reviewing
  your code might know a more efficient way to do something you're trying
  to do. Maybe there's a standard library you don't know about, or a datatype
  that's useful in this situation.
- Containers are useful tools in this situation. Containers can create easily
distributed, standardized environments for your code to run on, only installing
the dependencies you specificy. This allows a workplace with different types of
software, and even different operating systems, to all work on the same code
without fear of "cross contamination". It allows a project to keep better track
of dependencies and make sure no 'outside software' is interfering with 
development.
